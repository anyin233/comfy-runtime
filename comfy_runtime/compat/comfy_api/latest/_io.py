...
class RemoteOptions:
    ...
    def __init__(self, route: str, refresh_button: bool,
...
def comfytype(io_type: str, **kwargs):
    ...
    * ``class Output(Output): ...`` -- custom output descriptor.
    ...
    def decorator(cls: T) -> T:
        if isinstance(cls, _ComfyType) or (isinstance(cls, type) and issubclass(cls, _ComfyType)):
...
class Input(_IO_V3):
    ...
    def __init__(self, id: str, display_name: str = None, optional=False,
                 tooltip: str = None, lazy: bool = None, extra_dict=None,
                 raw_link: bool = None, advanced: bool = None):
        super().__init__()
        self.id = id
...
class WidgetInput(Input):
    ...
    def __init__(self, id: str, display_name: str = None, optional=False,
                 tooltip: str = None, lazy: bool = None, default: Any = None,
                 socketless: bool = None, widget_type: str = None,
                 force_input: bool = None, extra_dict=None,
                 raw_link: bool = None, advanced: bool = None):
...
class Output(_IO_V3):
    ...
    def __init__(self, id: str = None, display_name: str = None,
                 tooltip: str = None, is_output_list=False):
        self.id = id
...
class Boolean(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        ...
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, lazy: bool = None,
...
class Int(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        ...
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, lazy: bool = None,
                     default: int = None, min: int = None, max: int = None,
                     step: int = None,
...
class Float(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        ...
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, lazy: bool = None,
                     default: float = None, min: float = None, max: float = None,
                     step: float = None, round: float = None,
                     display_mode: NumberDisplay = None,
...
class Combo(ComfyTypeIO):
    ...
    class Output(Output):
        def __init__(self, id: str = None, display_name: str = None,
                     options: list[str] = None, tooltip: str = None,
...
class MultiCombo(ComfyTypeI):
    ...
    class Input(Combo.Input):
        def __init__(self, id: str, options: list[str], display_name: str = None,
                     optional=False, tooltip: str = None, lazy: bool = None,
                     default: list[str] = None, placeholder: str = None,
                     chip: bool = None,
                     control_after_generate: bool | ControlAfterGenerate = None,
                     socketless: bool = None, extra_dict=None,
                     raw_link: bool = None, advanced: bool = None):
            super().__init__(id, options, display_name, optional, tooltip, lazy,
                             default, control_after_generate,
                             socketless=socketless, extra_dict=extra_dict,
                             raw_link=raw_link, advanced=advanced)
...
class Webcam(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        ...
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, lazy: bool = None, default: str = None,
                     socketless: bool = None, extra_dict=None,
                     raw_link: bool = None, advanced: bool = None):
            super().__init__(id, display_name, optional, tooltip, lazy, default,
                             socketless, None, None, extra_dict, raw_link, advanced)
...
class ImageCompare(ComfyTypeI):
    ...
    class Input(WidgetInput):
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, socketless: bool = True,
                     advanced: bool = None):
            super().__init__(id, display_name, optional, tooltip, None, None,
                             socketless, None, None, None, None, advanced)
...
class Color(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, socketless: bool = True,
                     advanced: bool = None, default: str = "#ffffff"):
...
class BoundingBox(ComfyTypeIO):
    ...
    class Input(WidgetInput):
        def __init__(self, id: str, display_name: str = None, optional=False,
                     tooltip: str = None, socketless: bool = True,
                     default: dict = None, component: str = None,
...
class MultiType:
    ...
    class Input(Input):
        ...
        """
        def __init__(self, id: str | Input, types: list[type[_ComfyType] | _ComfyType],
                     display_name: str = None, optional=False, tooltip: str = None,
                     lazy: bool = None, extra_dict=None, raw_link: bool = None,
                     advanced: bool = None):
...
class MatchType(ComfyTypeIO):
    ...
    class Template:
        ...
        def __init__(self, template_id: str,
                     allowed_types: _ComfyType | list[_ComfyType] = None):
    ...
    class Input(Input):
        def __init__(self, id: str, template: "MatchType.Template",
                     display_name: str = None, optional=False,
                     tooltip: str = None, lazy: bool = None,
                     extra_dict=None, raw_link: bool = None,
                     advanced: bool = None):
            super().__init__(id, display_name, optional, tooltip, lazy, extra_dict, raw_link, advanced)
    ...
    class Output(Output):
        def __init__(self, template: "MatchType.Template", id: str = None,
                     display_name: str = None, tooltip: str = None,
                     is_output_list=False):
...
class Autogrow(ComfyTypeI):
    ...
    @staticmethod
    def _expand_schema_for_dynamic(out_dict, live_inputs, value, input_type, curr_prefix):
        ...
        if template_input is None:
            raise Exception("template_input could not be determined; this should never happen.")
...
class DynamicSlot(ComfyTypeI):
    ...
    class Input(DynamicInput):
        def __init__(self, slot: Input, inputs: list[Input],
                     display_name: str = None, tooltip: str = None,
                     lazy: bool = None, extra_dict=None):
            ...
            super().__init__(slot.id, self.slot.display_name, optional,
                             self.slot.tooltip, self.slot.lazy, self.slot.extra_dict)
            self.inputs = inputs
...
class HiddenHolder:
    ...
    def __init__(self, unique_id: str, prompt: Any, extra_pnginfo: Any,
                 dynprompt: Any, auth_token_comfy_org: str,
                 api_key_comfy_org: str, **kwargs):
...
class Schema:
    ...
    def get_v1_info(self, cls) -> NodeInfoV1:
        ...
        info = NodeInfoV1(
            input=input_dict,
            input_order={key: list(value.keys()) for (key, value) in input_dict.items()},
...
def get_finalized_class_inputs(d: dict[str, Any], live_inputs: dict[str, Any],
...
def parse_class_inputs(out_dict: dict[str, Any], live_inputs: dict[str, Any],
                       curr_dict: dict[str, Any],
                       curr_prefix: list[str] | None = None) -> None:
...
class NodeOutput(_NodeOutputInternal):
    ...
    """
    def __init__(self, *args: Any, ui=None, expand: dict = None,
